...
import backList from '../../../../../images/icons/backList.png';
			...
			<ScrollView style={container}>
                <View style={wrapper}>
                    <View style={header}>
                        ...
                        <Text style={titleStyle}>asdsad</Text>
                        <View style={{ width: 30 }} />
                    </View>
                    <View>
                    	<View style={productContainer}>
                            ...
                            <View style={productInfo}>
                                <Text style={txtName}>asdsad</Text>
                                <Text style={txtPrice}>123$</Text>
                                <Text style={txtMaterial}>Material 123123</Text>
                                <View style={lastRowInfo}>
                                    <Text style={txtColor}>Colo 2132sd</Text>
